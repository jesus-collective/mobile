...
export default {
  ...
  // Button
  btnFontFamily: platform === "ios" ? "Helvetica Neue" : "Helvetica Neue",
...
brandPrimary: platform === "ios" ? "#F0493E" : "#F0493E",
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === "ios" ? "Helvetica Neue" : "Helvetica Neue",
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Title
  titleFontfamily: platform === "ios" ? "Helvetica Neue" : "Helvetica Neue",
