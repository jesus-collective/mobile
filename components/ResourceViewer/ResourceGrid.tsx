...
export function ResourceGridAdmin(props: ResourceAdminProp): JSX.Element | null {
  ...
  return (
    <>
      ...
      {props.settings.style == ResourcePageItemStyle.GridAuto ? (
        <ResourceSelector {...props} />
      ) : null}
    </>
  )
}
function ResourceGrid(props: Props) {
  const resourceContext = useContext(ResourceContext)
  ...
  return (
    ...
    >
      ...
      <View style={styles.style.resourceGridContainer}>
        <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
          {props.pageItem.style == ResourcePageItemStyle.GridManual
            ? renderManualCards()
            : renderAutoCards()}
        </View>
      </View>
