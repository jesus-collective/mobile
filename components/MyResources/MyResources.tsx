      ...
      <StyleProvider style={getTheme(material)}>
        ...
        <Container style={{ flexDirection: 'column' }}>
          <Container style={{ minHeight: 40, flexDirection: 'row', justifyContent: 'space-between'}} >
            <Button transparent><Text style={styles.fontSliderHeader}>My Resources</Text></Button>
            <Container style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
              ...
              <Button bordered style={styles.sliderButton}><Text>+ Create Resource</Text></Button>
            </Container>
          </Container>
