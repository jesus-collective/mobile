                    ...
                    <div id="comment-div" style={{ width: '100%' }}>
                        ...
                        {!convertFromRaw(JSON.parse(this.state.value)).hasText() || this.state.value == null ?
                            ...
                            <div
                                ...
                                style={{ fontFamily: 'Graphik-Regular-App', fontSize: '16px', lineHeight: '26px', color: "#333333", marginTop: 0, paddingTop: 0, paddingRight: '30px', minHeight: 50, maxHeight: 275, overflow: 'scroll' }}></div>}
                    </div>
                </TouchableOpacity>
        else
            return <div id="comment-div">
                <div dangerouslySetInnerHTML={{ __html: this.convertCommentFromJSONToHTML(this.state.value) }} style={this.styles.style.courseDetailLongDescriptionText}></div>
            </div>
