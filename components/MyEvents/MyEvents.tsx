      ...
      <StyleProvider style={getTheme(material)}>
        ...
        <Container style={{ flexDirection: 'column'}}>
          <Container style={{ minHeight: 40, flexDirection: 'row', justifyContent: 'space-between'}} >
            <Button transparent><Text style={styles.fontSliderHeader}>My Events</Text></Button>
            <Container style={{ flexDirection: 'row', justifyContent: 'flex-end'}}>
              ...
              <Button bordered style={styles.sliderButton}><Text>+ Create Event</Text></Button>
            </Container>
          </Container>
              ...
              renderRow={() =>
                <ListItem >
                  <Card style={{ width: 300}}>
                    ...
                    <CardItem ><EvilIcons name="location" color="#cccccc"></EvilIcons><Text style={styles.fontDetail}>Calgary Community Center</Text></CardItem>
