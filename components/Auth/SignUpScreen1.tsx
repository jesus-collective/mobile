            ...
            <View style={this.styles.style.signUpScreen1PaymentBody}>
              ...
              <Content style={this.styles.style.signUpScreen1Content}>
                ...
                <View style={this.styles.style.signUpScreen1PaymentColumn2}>
                  ...
                  <View style={{ borderWidth: 1, borderStyle: "solid", borderRadius: 4, borderColor: "rgba(51, 51, 51, 0.1)", shadowColor: "rgba(0, 0, 0, 0.45)", padding: 25, shadowOffset: { width: 5, height: 5 }, shadowRadius: 30 }}>
