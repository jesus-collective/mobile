            ...
            this.props.authState === 'requireNewPassword' ?
                (<View style={{ width: "100%", left: 0, top: 0, height: "100%" }}>
                    ...
                    <View style={this.styles.style.authView2}>
                        ...
                        <JCButton buttonType={ButtonTypes.SolidSignIn} onPress={() => { this.save() }}>{this.state.reseting ? <ActivityIndicator animating color="#333333" /> : 'Submit'}</JCButton>
