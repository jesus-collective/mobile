...
export default class HeaderJC extends JCComponent<Props, State> {
  ...
  constructor(props: Props) {
    ...
    this.state = {
      ...
      chevronStyle:
        Dimensions.get("window").width > 720 ? chevronStyle1 : chevronStyle2,
    };
  }
          ...
          return (
            <Header style={this.headerStyles.style.container}>
              ...
              <Body style={this.styles.style.headerMiddleBody}>
                ...
                {constants["SETTING_ISVISIBLE_resource"] ? (
                  <button
                    ...
                    onMouseEnter={() =>
                      this.setState({ resourcesStyle: resourcesStyle2 })
                    }
                    onMouseLeave={() =>
                  ...
                  >
                    <div style={{ display: "flex", flexDirection: "row" }}>
                      <Text
                        style={
                          this.headerStyles.style.centerMenuButtonsTextResources
                        }
                      >
                        Resources
                      </Text>
              ...
              <Right style={this.headerStyles.style.headerRightContainer}>
                {constants["SETTING_ISVISIBLE_ADMIN"] &&
