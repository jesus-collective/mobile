...
import { Icon, Picker, StyleProvider, Container, Content, Card } from 'native-base';
                        ...
                        <Container style={{ flex: 70, flexDirection: "column", justifyContent: 'flex-start', paddingLeft: '5%', marginRight: 30 }}>
                          <Container style={{ flexDirection: 'row', paddingBottom: 30, paddingTop: 30, marginBottom: 250 }}>  
                            ...
                            <Container style={{ flex: 80, height: 200 }}>
                              <Text style={{ marginTop: 30, marginLeft: 60, marginRight: 30, fontFamily: 'Graphik-Regular-App', fontSize: 20, lineHeight: 30 }}>Hi </Text>
                              <Text style={{ marginTop: 30, marginLeft: 60, marginRight: 30, fontFamily: 'Graphik-Regular-App', fontSize: 20, lineHeight: 30 }}>For your journey in leadership formation, I’d like to invite you to our bi-weekly coaching sessions where we can connect and discuss issues in more details. Let’s schedule our Coaching Calls - talk soon!
                          ...
                          <Card style={{ width: '100%', borderColor: '#FFFFFF', paddingLeft: 30, paddingRight: 30, boxShadow: '0 6px 20px 0 rgba(0, 0, 0, 0.19)', marginTop: 100, paddingTop: 30, paddingBottom: 30, height: 400 }}>
                            ...
                            <Container style={{ flexDirection: "row" }}>
                              <Container style={{ flex: 40, marginTop: 30, height: 50, marginRight: 30 }}>
                                <Picker
                                  mode="dropdown"
                                  iosIcon={<Icon name="arrow-down" />}
                                  style={{ width: '100%', height: 50, paddingLeft: 15, paddingRight: 15 }}
                              ...
                              <Container style={{ flex: 60, marginTop: 30, height: 'auto', alignContent: 'space-between' }}>
                                <Container>
                                  <Text style={{ fontFamily: 'Graphik-Regular-App', fontSize: 28, lineHeight: 33 }}>Please confirm</Text>
                                  <Text style={{ fontFamily: 'Graphik-Regular-App', fontSize: 16, lineHeight: 24 }}>you’re going to schedule coaching call with Jon Hand.</Text>
                                  <Text style={{ fontFamily: 'Graphik-Regular-App', fontSize: 14, lineHeight: 24, marginTop: 35 }}>30 minutes</Text>
                                  <Text style={{ fontFamily: 'Graphik-Regular-App', fontSize: 14, lineHeight: 24 }}>Monday, August 23  -  1:30 PM – 2:00 PM</Text>
                                </Container>
                                <JCButton buttonType={ButtonTypes.CourseHome} onPress={() => { null }}>Yes, schedule call</JCButton>
                              </Container>
                            </Container>
                          </Card>
                        </Container>
