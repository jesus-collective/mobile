                      ...
                      <Container style={{ display: "flex", flexDirection: "row", justifyContent: 'flex-start', paddingLeft: '6%', paddingRight: '2%' }}>
                        ...
                        <Container style={{ flex: 30, flexDirection: "column", alignContent: 'flex-start', alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                          <Container style={{ flex: 5, flexDirection: "row", marginTop: 30, borderBottom: '1px solid #333333', width: '95%', paddingBottom: 30 }}>
                            <JCButton buttonType={state.activeMessageBoard == "cohort" ? ButtonTypes.TransparentCourse : ButtonTypes.courseTransparentBoldBlack} onPress={() => { actions.setActiveMessageBoard("cohort") }}>Cohort</JCButton>
                            <JCButton buttonType={state.activeMessageBoard == "triad" ? ButtonTypes.TransparentCourse : ButtonTypes.courseTransparentBoldBlack} onPress={() => { actions.setActiveMessageBoard("triad") }}>Triad</JCButton>
                            <JCButton buttonType={state.activeMessageBoard == "instructor" ? ButtonTypes.TransparentCourse : ButtonTypes.courseTransparentBoldBlack} onPress={() => { actions.setActiveMessageBoard("instructor") }}>Instructor</JCButton>
                          </Container>
