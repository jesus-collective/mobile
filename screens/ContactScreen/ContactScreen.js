...
import { NavigationEvents } from 'react-navigation';
 ...
 export default class ContactScreen extends Component {
  state = {
    url: "http://jesuscollective.com/contact",
  };
  ...
  render() {
    ...
    return (
      <Container>
       <NavigationEvents onWillFocus={payload => {this.setState({url: "http://jesuscollective.com/contact"});console.log('will focus',payload)}} />
