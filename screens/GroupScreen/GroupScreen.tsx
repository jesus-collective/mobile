            ...
            <Content>
              <Container style={{ display: "flex", flexDirection: "row", justifyContent: 'flex-start' }}>
                <Container style={{ flex: 30, flexDirection: "column", alignContent: 'flex-start', alignItems: 'flex-start', justifyContent: 'flex-start' }}>
                  ...
                  {this.state.canJoin ?
                    <Button onPress={() => { this.join() }} bordered style={styles.sliderButton}><Text>Join Group</Text></Button> :
                    null
                  }
                  {this.state.canLeave ?
                    <Button onPress={() => { this.leave() }} bordered style={styles.sliderButton}><Text>Leave Group</Text></Button> :
                    null
                  }
                  ...
                  {this.state.canDelete ?
                    <Button onPress={() => { if (window.confirm('Are you sure you wish to delete this group?')) this.delete() }} bordered style={styles.sliderButton}><Text>Delete Group</Text></Button>
                    : null
                  }
