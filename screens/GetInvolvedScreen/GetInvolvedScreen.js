...
import { NavigationEvents } from 'react-navigation';
 ...
 export default class GetInvolvedScreen extends Component {
  state = {
    url: "http://jesuscollective.com/get-involved",
  };
  ...
  render() {
    ...
    return (
      <Container>
       <NavigationEvents onWillFocus={payload => {this.setState({url: "http://jesuscollective.com/get-involved"});console.log('will focus',payload)}} />
