...
import { NavigationEvents } from 'react-navigation';
 ...
 export default class SupportScreen extends Component {
  state = {
    url: "http://jesuscollective.com/support",
  };
  ...
  render() {
    ...
    return (
      <Container>
       <NavigationEvents onWillFocus={payload => {this.setState({url: "http://jesuscollective.com/support"});console.log('will focus',payload)}} />
