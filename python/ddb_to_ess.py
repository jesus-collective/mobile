...
logging.basicConfig()
client2 = boto3.client('lambda', region_name='us-east-1')
reports = []
object_amount = 0
partSize = 0
...
def main():
  ...
  client = boto3.client('lambda', region_name=args.rn,aws_access_key_id=args.ak,aws_secret_access_key=args.sk)
